...
class Mechanical:
	...
	def sensor_at_impact(self):
		...
		self._contact = True
		self._deployed = True 
		return self._weight,self._spinning_foil,self._contact,self._deployed
...
class Electrical:
	...
	def sensor_at_impact(self):
		...
		self._contact = True
		self._deployed = True 
		return self.state,self._contact,self._deployed
	...
	def wether_determination(self, visibility):	# ranges = 0-25 »» 25-50 »» 50-75 »» 75-90 »» 90-100		
		try:
			...
			if visibility > 100:
				...
				if visibility == 100.0 and visibility >= 90.0:
					self._l1 = "LOW"
					self._l2 = "LOW"
					self._l3 = "LOW"
					self._l4 = "LOW"
					self._visibility_data.append(visibility)
				elif visibility <= 90.0 and visibility >= 75.0:
					self._l1 = "LOW"
					self._l2 = "LOW"
					self._l3 = "LOW"
					self._l4 = "HIGH"
					self._visibility_data.append(visibility)
				elif visibility <= 75.0 and visibility >= 50.0:
					self._l1 = "LOW"
					self._l2 = "HIGH"
					self._l3 = "LOW"
					self._l4 = "HIGH"
					self._visibility_data.append(visibility)
				elif visibility <= 50.0 and visibility >= 25.0:
					self._l1 = "LOW"
					self._l2 = "HIGH"
					self._l3 = "HIGH"
					self._l4 = "HIGH"
					self._visibility_data.append(visibility)
				elif visibility <= 25.0 and visibility >= 0:
					self._l1 = "HIGH"
					self._l2 = "HIGH"
					self._l3 = "HIGH"
					self._l4 = "HIGH"
