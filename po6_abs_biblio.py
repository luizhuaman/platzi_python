...
class Libro:
    def __init__(self, titulo, autor, cantidad_de_paginas, genero, sinopsis):
        ...
        self.info_libro_agregado(titulo, autor, cantidad_de_paginas, genero, sinopsis)
    
    def info_libro_agregado(self, titulo, autor, cantidad_de_paginas, genero, sinopsis):
        print(f'{titulo}\n{autor}\n{cantidad_de_paginas}\n{genero}\n{sinopsis}')
